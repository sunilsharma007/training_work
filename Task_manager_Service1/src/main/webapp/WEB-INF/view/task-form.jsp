...
<div id="container" align="center">
    <form:form action="saveTask" modelAttribute="task" method="POST" cssStyle="border-style: solid">
        ...
        <div class="form-group">
            ...
            <form:input type ="date" path="taskSDate"/>
            <form:errors path="taskSDate" cssClass="error" />
        </div>
        <div class="form-group">
            <label>Target Date:</label>
            <form:input type ="date" path="taskEDate"/>
            <form:errors path="taskEDate" cssClass="error" />
        </div>
        <br/>
        <div class="form-group">
